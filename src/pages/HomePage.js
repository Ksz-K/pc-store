      ...
      <div className="home">
        <div className="history seen">
          <h5 className="info-heading">
            ...
            kreowała podwaliny polskiego rynku IT. Dziś po upływie ponad ponad
            30 lat nadal aktywnie działa w polskie branży IT, oferując systemy
